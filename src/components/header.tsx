...
const Header: React.FC = () => {
  ...
  return (
    <>
      ...
      <nav
        id="main-nav"
        className="fixed top-0 left-0 right-0 h-16 z-[1000] px-[clamp(16px,5vw,60px)] flex items-center justify-between backdrop-blur-[20px] bg-bg/70 border-b border-border transition-all duration-300"
      >
        <div
      ...
      <div
        id="section-dots"
        className="fixed right-6 top-1/2 -translate-y-1/2 z-[500] hidden lg:flex flex-col gap-[10px]"
      >
